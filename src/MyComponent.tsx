          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((item) => (
              <div key={item} className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                <h2 className="text-xl font-semibold mb-3 text-slate-800">Feature {item}</h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-slate-600 hover:text-[#1a5de6] transition-colors">Privacy</a>
              <a href="#" className="text-slate-600 hover:text-[#1a5de6] transition-colors">Terms</a>
              <a href="#" className="text-slate-600 hover:text-[#1a5de6] transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </footer>
