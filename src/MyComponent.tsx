        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              {['Home', 'Shop', 'About', 'Blog', 'FAQ', 'Contact'].map((item) => (
                <Link
                  key={item}
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-8 font-quicksand">
              Discover our range of nutritious, organic baby foods crafted with love for every stage of your baby's growth journey.
            </p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "0-6 Months", image: "/placeholder.svg", link: "/shop?age=0-6" },
                { title: "6-12 Months", image: "/placeholder.svg", link: "/shop?age=6-12" },
                { title: "12-24 Months", image: "/placeholder.svg", link: "/shop?age=12-24" },
                { title: "24+ Months", image: "/placeholder.svg", link: "/shop?age=24+" }
              ].map((category) => (
                <Link
                  key={category.title}
                  to={category.link}
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((item) => (
                <div key={item} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-slate-100 overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-slate-600 text-sm mb-4 line-clamp-2 font-quicksand">
                      Nutritious and delicious organic baby food made with premium ingredients.
                    </p>
          ...
          <div className="bg-[#F5F9FF] rounded-3xl p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  title: "100% Organic",
                  description: "All our ingredients are certified organic, with no pesticides or harmful chemicals.",
                  icon: "🌱"
                },
                {
                  title: "Nutritionist Approved",
                  description: "Our recipes are developed by pediatric nutritionists for optimal development.",
                  icon: "🥦"
                },
                {
                  title: "No Added Sugar",
                  description: "We never add refined sugar or artificial sweeteners to our products.",
                  icon: "🍯"
                }
              ].map((feature) => (
                <div key={feature.title} className="bg-white p-6 rounded-2xl text-center">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                <h4 className="font-semibold text-slate-800 mb-3 font-quicksand">Shop</h4>
                <ul className="space-y-2">
                  <li><Link to="/shop" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">All Products</Link></li>
                  <li><Link to="/shop" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">By Age</Link></li>
                  <li><Link to="/shop" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">By Category</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-slate-800 mb-3 font-quicksand">About</h4>
                <ul className="space-y-2">
                  <li><Link to="/about" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">Our Story</Link></li>
                  <li><Link to="/about" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">Our Team</Link></li>
                  <li><Link to="/blog" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">Blog</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-slate-800 mb-3 font-quicksand">Help</h4>
                <ul className="space-y-2">
                  <li><Link to="/faq" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">FAQ</Link></li>
                  <li><Link to="/contact" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">Contact Us</Link></li>
                  <li><Link to="/faq" className="text-slate-600 hover:text-[#1a5de6] transition-colors font-quicksand">Shipping</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-slate-800 mb-3 font-quicksand">Follow Us</h4>
                <div className="flex space-x-4">
                  <a href="#" className="text-slate-600 hover:text-[#1a5de6] transition-colors">
